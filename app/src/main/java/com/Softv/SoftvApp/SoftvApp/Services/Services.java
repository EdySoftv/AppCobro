package com.Softv.SoftvApp.SoftvApp.Services;
...
import static com.Softv.SoftvApp.SoftvApp.Fragments.EjecutarReportes.year;
import static com.Softv.SoftvApp.SoftvApp.Fragments.EjecutarOrdenes.añoE;
import static com.Softv.SoftvApp.SoftvApp.Fragments.EjecutarOrdenes.diaE;
import static com.Softv.SoftvApp.SoftvApp.Fragments.EjecutarOrdenes.mesE;
import static com.Softv.SoftvApp.SoftvApp.Fragments.HorasReportes.TecSecSelecc1;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.EFDM;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.EIMD;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.IFDM;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.IIDM;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.clvTipoDescMat;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.extSer;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.idInventarioMD;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesOrdenes.totalDM;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.EFDMR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.EIMDR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.IFDMR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.IIDMR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.clvTipoDescMatR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.extSerR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.idInventarioMDR;
import static com.Softv.SoftvApp.SoftvApp.Fragments.MaterialesReportes.totalDMR;
...
//POST Body JsonArray
    ...
    public Service addPreDescargaService(final Context context) {
        ...
        JSONObject jsonObject = new JSONObject();
        int escable;
        if (com.Softv.SoftvApp.SoftvApp.Request.Request.pieza == true) {
            escable = 0;
        } else {
            escable = 1;
        }
    ...
    public Service RequestImagen(final Context context, JSONObject jsonObject) {
        MediaType JSON = MediaType.parse("application/json; charset=utf-8");

        final RequestBody body = RequestBody.create(JSON, jsonObject.toString());
        //RequestBody body2 = Request
   ...
   /* public Service getGuardaCoordenadasRService(final Context context) throws JSONException {
        ...
        JSONObject jsonObject1 = new JSONObject();
        jsonObject.put("Contrato", com.Softv.SoftvApp.SoftvApp.Request.Request.abc);
        jsonObject.put("Latitud", HorasReportes.cordLatR.getText());
        jsonObject.put("Longitud", HorasReportes.cordLongR.getText());
        jsonObject1.put("ObjCoorCli", jsonObject);
        MediaType JSON = MediaType.parse("application/json; charset=utf-8");
        final RequestBody body = RequestBody.create(JSON, jsonObject1.toString());
        final OkHttpClient client = new OkHttpClient.Builder().addInterceptor(new Interceptor() {
