package com.Softv.Bolivia.prueba7.Services;
...
import com.Softv.Bolivia.prueba7.Fragments.HorasReportes;
...
import com.Softv.Bolivia.prueba7.sampledata.Constants;
...
import static com.Softv.Bolivia.prueba7.Adapters.QuejasAdapter.contratoReport;
import static com.Softv.Bolivia.prueba7.Adapters.TrabajosAdapter.ClaveTrabajo;

import static com.Softv.Bolivia.prueba7.Fragments.EjecutarReportes.horas12;

import static com.Softv.Bolivia.prueba7.Fragments.EjecutarReportes.solution;
import static com.Softv.Bolivia.prueba7.Fragments.EjecutarReportes.year;
import static com.Softv.Bolivia.prueba7.Fragments.EjecutarOrdenes.añoE;
import static com.Softv.Bolivia.prueba7.Fragments.EjecutarOrdenes.diaE;
import static com.Softv.Bolivia.prueba7.Fragments.EjecutarOrdenes.mesE;
import static com.Softv.Bolivia.prueba7.Fragments.HorasReportes.TecSecSelecc1;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.EFDM;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.EIMD;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.IFDM;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.IIDM;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.clvTipoDescMat;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.extSer;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.idInventarioMD;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesOrdenes.totalDM;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.EFDMR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.EIMDR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.IFDMR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.IIDMR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.clvTipoDescMatR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.extSerR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.idInventarioMDR;
import static com.Softv.Bolivia.prueba7.Fragments.MaterialesReportes.totalDMR;
import static com.Softv.Bolivia.prueba7.Fragments.TrabajosReportes.Clv_Sol;
import static com.Softv.Bolivia.prueba7.Request.Request.Obs;
import static com.Softv.Bolivia.prueba7.Request.Request.clvP;
...
//POST Body JsonArray
    ...
    public Service getAsignadosService(final Context context) throws JSONException {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("Contrato", com.Softv.Bolivia.prueba7.Request.Request.abc);
        MediaType JSON = MediaType.parse("application/json; charse=utf-8");
        final RequestBody body = RequestBody.create(JSON, jsonObject.toString());
        final OkHttpClient client = new OkHttpClient.Builder().addInterceptor(new Interceptor() {
            @Override
    ...
    public Service addPreDescargaService(final Context context) {
        ...
        JSONObject jsonObject = new JSONObject();
        int escable;
        if (com.Softv.Bolivia.prueba7.Request.Request.pieza == true) {
            escable = 0;
        } else {
            escable = 1;
        }
